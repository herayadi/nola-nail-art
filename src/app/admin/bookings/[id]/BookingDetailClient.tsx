...
export default function BookingDetailClient({
  ...
  const selectedAddons =
    booking.service.addons?.filter((a: any) =>
  ...
  return (
    <div className={styles.container}>
      <Link
        href="/admin/bookings"
        className="flex items-center gap-2 text-gray-400 hover:text-accent mb-8 transition-colors text-sm font-bold uppercase tracking-widest"
      >
        ...
        <div className="space-y-8">
            ...
            <div className={styles.infoSection}>
              ...
              <div className="mt-6 space-y-6">
                <div className="flex justify-between items-start">
                  <div>
                    <p className={styles.value} style={{ fontSize: "1.5rem" }}>
                    ...
                    <p
                      ...
                      style={{ fontSize: "1rem" }}
                    >
                      {booking.service.duration} Session
                    </p>
                  </div>
                ...
                <div className={styles.customerNote}>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span
                      ...
                      style={{ color: "var(--admin-accent)", marginBottom: 0 }}
                    >
          ...
          <div className={styles.card}>
            ...
            <div className={styles.timeline}>
              ...
              <div
                className={`${styles.timelineItem} ${booking.status !== "PENDING" ? styles.timelineItemActive : ""}`}
              >
                <div className={styles.stepIcon}>
                  <CheckCircle size={18} />
                </div>
                <div className={styles.stepContent}>
                  ...
                  <span className={styles.stepTime}>
                    {booking.status === "PENDING"
                      ? "Menunggu tindakan..."
                      : `Dikonfirmasi pada ${new Date(booking.updatedAt).toLocaleString()}`}
                  </span>
                </div>
              </div>
        ...
        <div className="space-y-8">
          ...
          <div className={styles.card}>
            ...
            <div className="space-y-6">
              ...
              >
                Pastikan Anda telah mengecek mutasi rekening sebelum melakukan
                konfirmasi lunas.
              </p>
            </div>
          </div>
